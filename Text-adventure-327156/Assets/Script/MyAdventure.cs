...
public class MyAdventure : MonoBehaviour
{
    ...
    void OnUserInput(string input)
    {
        ...
        else if (currentState == States.binnen)
        {
            ...
            else if (currentState == States.schuil)
            {
                if (input == "pak")
                {
                    wapen();
            ...
            else if (currentState == States.wapen)
            {
                if (input == "menu")
                {
                    ShowMainmenu();
    ...
    void Geweer()
    {
        ...
        Terminal.WriteLine("Wil je naar hem toe gaan of wegrennen.");
    ...
    void schuil()
    {
        ...
        Terminal.WriteLine("Typ toegaan om naar hem toe te gaan.");
        Terminal.WriteLine("Typ wegrennen om te schuilen.");
        currentState = States.schuil;
    }

    void naarman()
    {
        Terminal.ClearScreen();
        Terminal.WriteLine("je rent naar de man toe.");
        Terminal.WriteLine("hij schiet je neer.");
        Terminal.WriteLine("typ menu om terug te gaan.");
        currentState = States.naarman;
    }

    void wapen()
    {
        Terminal.ClearScreen();
        Terminal.WriteLine("ziet een wapen.");
        Terminal.WriteLine("je pakt get wapen op.");
        currentState = States.wapen;
    }

    void schiet()
    {
        Terminal.ClearScreen();
        Terminal.WriteLine("Je schiet de man neer.");
        Terminal.WriteLine("je leefde nog lang en gelukkig.");
        Terminal.WriteLine("Typ menu om naar het menu te gaan.");
        currentState = States.schiet;
    }
}
